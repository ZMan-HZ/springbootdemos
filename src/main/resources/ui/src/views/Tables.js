...
import {Button, ButtonGroup, Card, CardBody, CardHeader, Col, Container, Row,
    FormSelect,
    InputGroup,
    InputGroupAddon,
    InputGroupText,
...
class Tables extends Component {
    ...
    componentWillMount() {
        ...
        this.searcher = new FuzzySearch(this.state.tableData, ["customer", "status"], {
            caseSensitive: false
        });
    }
    ...
    render() {
        ...
        const tableColumns = [
            ...
            {
                Header: "Adress",
                accessor: "department.zipCode" + " - " + "department.district",
                className: "text-center",
                minWidth: 200
            },
            {
